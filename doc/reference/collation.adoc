...
void create_collation(connection_ref conn, cstring_ref name, Func && func);
template<typename Func>
void create_collation(connection_ref conn, cstring_ref name, Func && func, system::error_code &ec);

// Delete an existing collation.
void delete_collation(connection_ref conn, cstring_ref name, system::error_code & ec);
void delete_collation(connection_ref conn, cstring_ref name);
----
